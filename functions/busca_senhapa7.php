...
if ($stmt->execute())
{
    ...
    //echo "<spam class='text-center text-dark' style='font-size:12px;font-weight: 100;font-family:Roboto;'>Atualizado em: ".$data_receb." às: ".$strg->HrReceb."</spam>";
        ...
        <div class='row'>
            <div class='col-sm-12'>
                <h4 class ='text-center text-secondary' style='font-size:75px;font-weight: 900;font-family:helvetica;'>".$senha_atual."</h4><br>
            </div>
        </div>                   
        <div class='row'>
            <div class='col-sm-12'>
                <spam class='text-center text-dark' style='font-size:12px;font-weight:100;font-family:Roboto;'>Atualizado em:".$data_receb." às:".$strg->HrReceb."</spam>
            </div>
        </div>";
